...
title = expression(paste("Global emissions of ",PM[2.5]," in Baltimore City from 1999 to 2008"))
png("plot2.png")
boxplot(logged.nei.baltimore.data,main=title,xlab="year",
        ylab=expression(log[10](Emission)),notch=TRUE)
dev.off()